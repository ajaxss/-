    ...
    gorouter(e) {
        switch (e.target.innerHTML) {
            case "推荐":
                ...
                break;
            case "线上课":
                this.props.history.push("/index/online");
                break;
            case "线下课":
                this.props.history.push("/index/xianxia");
                break;
            default:
                break;
        }
        ...
        return (
            <div>
                ...
                <div className={learnCss.top} onClick={this.gorouter.bind(this)}>
                    <div className={learnCss.topnav1}>推荐</div>
                    <div className={learnCss.topnav}>线上课</div>
                    <div className={learnCss.topnav}>线下课</div>
                </div>
            </div>
        );
    }
